 ...
 let checkedTasks = new Set();
      ...
      if(editIndex==undefined){//addblock
       ...
       todoTask.forEach((ele,i)=>{
        ...
        <div class="card  bg-light mt-3 flex-grow-1" >
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center">
                    <p class="card-text text-black mb-0">${ele}</p>
                   
                </div>
              <div class="justify-content-between ">
              
              <button type="button" class="btn btn-danger" onclick="deleteTask(${i})" >Delete</button>
              <button type="button" class="btn btn-warning" onclick="editTask(${i})" >Edit</button></div>
